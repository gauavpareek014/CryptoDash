...
import {Form, FormGroup, Alert, ControlLabel, FormControl, Col, Panel, Button} from 'react-bootstrap';
    ...
    render() {
        return (
            <Panel bsStyle="default">
                <Panel.Heading>
                    <Panel.Title componentClass="h3">User Profile</Panel.Title>
                </Panel.Heading>
                <Panel.Body>
                    <Form horizontal className="customForm" onSubmit={this.handleSubmit.bind(this)}>
                        <FormGroup controlId="formHorizontalEmail">
                            ...
                            <Col sm={10} lg={4}>
                                <FormControl type="email" placeholder="Email" defaultValue={this.state.email}
                        ...
                        <FormGroup controlId="formHorizontalFirstName">
                            ...
                            <Col sm={10} lg={4}>
                                <FormControl type="text" ref="firstName" placeholder="FirstName"
                                             defaultValue={this.state.fName} required/>
                            </Col>
                        </FormGroup>
                        ...
                        <FormGroup controlId="formHorizontalContact">
                            ...
                            <Col sm={10} lg={4}>
                                <FormControl type="text" placeholder="Contact" ref="contact"
                        ...
                        <FormGroup controlId="formHorizontalAddress">
                            ...
                            <Col sm={10} lg={4}>
                                <FormControl componentClass="textarea" placeholder="Address" ref="address"
                                             defaultValue={this.state.add} required/>
                            </Col>
                        </FormGroup>
